                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    	<%
                                    	for(Product usr:productos){
                                    		out.println("<tr>");
                                    		out.println("<td>"+ usr.getCodigoBarra() +"</td>");
                                    		out.println("<td>"+ usr.getNombre() +"</td>");
                                    		out.println("<td>"+ usr.getPrecioFinal() +"</td>");
                                    		out.println("<td>"+ usr.getUnidadId() +"</td>");
                                    		//out.println("<td><a href='/products/view?mercaderiaId="+usr.getId()+"'>View</a> "+
                                    		//	"<a href='/products/view?mercaderiaId="+usr.getId()+"'>Editar</a> "+
